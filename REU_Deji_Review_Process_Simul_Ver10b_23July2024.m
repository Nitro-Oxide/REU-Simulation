...
%This is the simulation with a varying arrival rate.
clear all;
...
Mr = zeros(5,1); %Mean Rate of Arrival
...
% m is a variable used to modify the upper mound of n_a's interval

% n_a is the number of arrivals in a day, 
...
for m = 1:10 
   n_a = randi(2*(10+5*m)-1); 
   cmu = unifrnd(1,59); %This loop is for the number of seasons 
   ...
   for iteration = 1:1000  %This represents the number of days being simulated
       for day = 1:180 
           ...
           while(n_a ~= 0) %Applicants arrive from infinite source
            ...
            n_a = randi(2*(10+5*m)-1); %The number of arrivals for the next 
                                       %    day is generated
...
tbl = renamevars(tbl,["Mr","MA","MR","MRNG","MB","MP","MNA"],[ ...
    "Mean Rate of Arrival","Mean Admitted","Mean Rejected", ...
